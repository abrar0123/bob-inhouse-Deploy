...
export default function PropertyFilteringMapFive({ locations }) {
  ...
  if (listingError) {
    return <Error error={listingError} />;
  }
            ...
            <div className="col-xl-5">
              <div className="half_map_area_content mt30">
                ...
                <div className="row align-items-center mb10">
                  {/* <TopFilterBar pageContentTrac={pageContentTrac} /> */}
                </div>
                {/* p1 */}
