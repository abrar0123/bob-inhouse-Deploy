...
const ComapareTable = () => {
  ...
  return !comparisonPools || comparisonPools.length === 0 ? (
    <p className="page-empty-text">
      No pools are selected for comparsion. Please go to{' '}
      <a href="/vergelijk-zwembad">vergelijk-zwembad</a> page and select some
      pools.
    </p>
  ) : (
    <table className="table table-borderless mb-0">
      <thead className="t-head">
        <tr>
          <th scope="col" />
          {comparisonPools.map((item, index) => (
